...
#define PC_PANEL_DEFAULT_HEIGHT 24
#define PC_PANEL_DEFAULT_WIDTH 0.98f
#define PC_PANEL_DEFAULT_ALIGN PC_ALIGN_BOTTOM
#define PC_PANEL_DEFAULT_STRUT_ENABLED TRUE
